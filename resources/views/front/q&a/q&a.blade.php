        ...
        <section id="contact-us">
            <div class="contact">
                <div class="new-container">
                    ...
                    <form action="{{asset('/contact')}}" method="POST" class="mt-5">
                        @csrf
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingTextarea" name="name" placeholder="姓名">
                            <label for="floatingTextarea">姓名</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingTextarea" name="title" placeholder="主題">
                            <label for="floatingTextarea">主題</label>
                        </div>
                        <div class="form-floating mb-3">
