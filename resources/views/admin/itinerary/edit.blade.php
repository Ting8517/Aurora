    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('itinerary.update',['id'=>$itinerary->id])}}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <img src="{{Storage::url($itinerary->image_url)}}" alt="" width="300">
                            </div>
                        </div><div class="form-group row py-2">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="content" id="content" rows="5" required>{{$itinerary->content}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row py-2">
