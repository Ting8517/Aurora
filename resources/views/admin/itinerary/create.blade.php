                            ...
                            <div class="col-sm-11">
                                <select class="form-control my-1 mr-sm-2" id="country" name="country_id" required>
                                    ...
                                    @foreach ($countries as $country)
                                        <option value="{{$country->id}}">{{$country->chinese_name}}</option>    
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row py-2">
                            <label for="place-chinese-name" class="col-sm-1 col-form-label">地點(中文)<span class="text-danger">*</span></label>
                            <div class="col-sm-11">
                                <input type="text" class="form-control" id="place-chinese-name" name="place_chinese_name" required>
                            </div>
                        </div>
                        <div class="form-group row py-2">
                            <label for="place-english-name" class="col-sm-1 col-form-label">地點(英文)<span class="text-danger">*</span></label>
                            <div class="col-sm-11">
                                <input type="text" class="form-control" id="place-english-name" name="place_english_name" required>
                            </div>
                        </div>
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img id="preview-img" class="mt-2" src="" alt="" width="200">
                            </div>
                        </div>
                        <div class="form-group row py-2">
