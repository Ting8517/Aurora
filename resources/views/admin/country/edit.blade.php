...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">編輯國家</li>
        </ol>
    </nav>
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header pt-3 pb-2">國家 - 編輯</h2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('country.update',['country'=>$country->id])}}">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-11">
                                <input type="text" class="form-control" id="chinese-name" name="chinese_name" value="{{$country->chinese_name}}" required>
                            </div>
                            <label for="english-name" class="col-sm-1 col-form-label">英文名稱<span class="text-danger">*</span></label>
                            <div class="col-sm-11">
                                <input type="text" class="form-control" id="english-name" name="english_name" value="{{$country->english_name}}" required>
                            </div>
                            ...
                            <div class="col-sm-11">
                                <select class="form-control my-1 mr-sm-2" id="continent" name="continent_id" required>
                                    ...
                                    @foreach ($continents as $continent)
                                        <option value="{{$continent->id}}" @if ($continent->id == $country->continent_id) selected @endif>   {{$continent->name}}</option>    
                                    @endforeach
                                </select>
                            </div>
                        </div>
